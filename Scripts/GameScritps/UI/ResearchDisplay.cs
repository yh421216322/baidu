...
namespace YourGameNamespace.UI
{
    public class ResearchDisplay : MonoBehaviour, IController
    {
        ...
        private ResearchSystem mResearchSystem; // Changed to interface if available, otherwise concrete
        ...
        void Start()
        {
            ...
            mResearchSystem = this.GetSystem<ResearchSystem>(); // Assuming IResearchSystem exists and is registered
            ...
            {
                mResearchSystem.CurrentlyResearching.RegisterWithInitValue(UpdateCurrentResearchInfo).UnRegisterWhenGameObjectDestroyed(this.gameObject); // Already correct
                mResearchSystem.CurrentResearchProgressNormalized.RegisterWithInitValue(UpdateResearchProgressUI).UnRegisterWhenGameObjectDestroyed(this.gameObject); // Already correct
            }
