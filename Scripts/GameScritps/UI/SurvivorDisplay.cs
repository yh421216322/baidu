...
namespace YourGameNamespace.UI
{
    public class SurvivorDisplay : MonoBehaviour, IController
    {
        ...
        private void Awake()
        {
            survivorListContainer = survivorListContainer ?? transform.Find("SurvivorDisplay_Panel/SurvivorListScrollView/Viewport/SurvivorListContainer")?.GetComponent<Transform>();
        }
