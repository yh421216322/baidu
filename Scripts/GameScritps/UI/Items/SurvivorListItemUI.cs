...
namespace YourGameNamespace.UI
{
    public class SurvivorListItemUI : MonoBehaviour
    {
        ...
        public void Setup(Survivor survivor)
        {
            ...
            mSurvivor.Name.RegisterWithInitValue(UpdateNameUI).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            mSurvivor.Status.RegisterWithInitValue(UpdateStatusUI).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            mSurvivor.FoodLevel.RegisterWithInitValue(UpdateFoodUI).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            mSurvivor.RestLevel.RegisterWithInitValue(UpdateRestUI).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            mSurvivor.Profession.RegisterWithInitValue(UpdateProfessionUI).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            mSurvivor.WorkstationId.RegisterWithInitValue(UpdateWorkstationUI).UnRegisterWhenGameObjectDestroyed(this.gameObject);
