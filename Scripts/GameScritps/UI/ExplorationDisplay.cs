...
using System;
using MyGameNamespace; // 用于 Guid (全局唯一标识符)
...
namespace YourGameNamespace.UI
{
    ...
    public class ExplorationDisplay : MonoBehaviour, IController
    {
        ...
        void Start() // Unity生命周期方法，在第一次Update前执行
        {
            ...
            this.RegisterEvent<Model_POIStatusUpdatedEvent>(e => RefreshAvailablePOIs()).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            this.RegisterEvent<Model_ActiveExpeditionAddedEvent>(e => RefreshActiveExpeditions()).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            this.RegisterEvent<Model_ActiveExpeditionRemovedEvent>(e => RefreshActiveExpeditions()).UnRegisterWhenGameObjectDestroyed(this.gameObject);
            this.RegisterEvent<Exploration_ExpeditionOutcomeResolvedEvent>(OnExpeditionOutcomeResolved).UnRegisterWhenGameObjectDestroyed(this.gameObject);
