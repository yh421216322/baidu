...
namespace YourGameNamespace.Time
{
    ...
    public class DayNightSystem : AbstractSystem, IDayNightSystem // Implements IDayNightSystem
    {
        ...
        private GEventSystem mEventSystem;        // 事件系统 (GEventSystem 是具体类名，假设有IGEventSystem接口)
        ...
        protected override void OnInit()
        {
            ...
            mCombatSystem = this.GetSystem<CombatSystem>(); // Use interface
            mEventSystem = this.GetSystem<GEventSystem>(); // Use interface, assuming IGEventSystem exists
