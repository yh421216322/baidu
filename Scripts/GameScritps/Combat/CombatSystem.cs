...
namespace YourGameNamespace.Combat
{
    ...
    public class CombatSystem : AbstractSystem, ICombatSystem // Implements the updated interface
    {
        ...
        private ObjectPoolSystem mObjectPoolSystem; // 对象池系统
        ...
        protected override void OnInit()
        {
            ...
            mObjectPoolSystem = this.GetSystem<ObjectPoolSystem>(); // 初始化对象池系统
        ...
        public void SpawnZombieWaveForDay(int day)
        {
            ...
            for (int i = 0; i < zombiesToSpawn; i++)
            {
                ...
                int baseAttack = UnityEngine.Random.Range(0, 0);
                ...
                string zombiePrefabName = "Prefabs/Zombie/Zombie_PF"; // 预制件在Resources下的路径
