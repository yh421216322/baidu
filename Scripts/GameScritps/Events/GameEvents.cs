...
namespace YourGameNamespace.Events
{
    ...
    public struct Model_TechnologyStatusUpdatedEvent
    {
        ...
        public YourGameNamespace.Research.Technology.ResearchStatus NewStatus; // 科技的新状态
        public YourGameNamespace.Research.Technology.ResearchStatus OldStatus; // 科技的旧状态
    }
    ...
    public struct Model_POIStatusUpdatedEvent
    {
        ...
        public YourGameNamespace.Exploration.ExplorationPointOfInterest.POIStatus NewStatus; // POI的新状态
        public YourGameNamespace.Exploration.ExplorationPointOfInterest.POIStatus OldStatus; // POI的旧状态
    }
    ...
    public struct Model_QuestStatusUpdatedEvent
    {
        ...
        public YourGameNamespace.Quests.Quest.QuestStatus NewStatus;    // 任务的新状态
        public YourGameNamespace.Quests.Quest.QuestStatus OldStatus;    // 任务的旧状态
    }
