...
using YourGameNamespace.Resources; // 用于 ExplorationModel (探索模型) 和 ExplorationSystem (探索系统)
...
public class RegisterManager : Architecture<RegisterManager>
{
    protected override void Init()
    {
     ...
     this.RegisterModel(new QuestModel());

     // 注册各种游戏逻辑系统
     this.RegisterSystem(new ObjectPoolSystem());          // 对象池系统
